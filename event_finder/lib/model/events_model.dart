    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        events!.add(Event.fromJson(
            v)); // Memastikan Event.fromJson dipanggil dengan benar
      });
    }
  }
...
class Event {
  ...
  factory Event.fromJson(Map<String, dynamic> json) {
    return Event(
        ...
        time: json['time'] != null
            ...
            : null, // Mengonversi time
        location: json['location'],
        description: json['description'],
        image: json['image'],
        category: json['category'] != null
            ? EventCategoryExtension.fromString(json['category'])
            : null, // Mengonversi string ke enum
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'image': image,
      'category': category
          ?.value, // Menggunakan EventCategoryExtension untuk mengambil value string
